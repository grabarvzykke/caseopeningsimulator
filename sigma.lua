...
-- Delay slider for autoclicker
local delayY
local delayFill
local delayMax
y, delayFill, delayMax = addSlider("AutoClick Delay (ms)", 1000, 300, y, Color3.fromRGB(0,255,150), function(v)
...
-- TOGGLE AUTOCLICKER [LEFT BRACKET]
uis.InputBegan:Connect(function(input, gp)
